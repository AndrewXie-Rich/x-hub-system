...
final class ModelStore: ObservableObject {
    ...
    nonisolated private static let systemVoiceTTSModelID = "system-voice-tts"
    nonisolated private static let systemVoiceTTSDefaultBinaryPath = "/usr/bin/say"
    nonisolated private static let systemVoiceTTSNote = "system_voice_compatibility; uses macOS system voice; no model download required"
