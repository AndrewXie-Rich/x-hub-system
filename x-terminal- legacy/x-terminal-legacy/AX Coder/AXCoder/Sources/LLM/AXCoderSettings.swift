...
struct AXCoderSettings: Codable, Equatable {
    ...
    static func `default`() -> AXCoderSettings {
        AXCoderSettings(
    ...
    func setting(role: AXRole, providerKind: ProviderKind, model: String?) -> AXCoderSettings {
        var s = self
