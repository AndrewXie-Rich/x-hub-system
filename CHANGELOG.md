...
Semantic Versioning for public release tags.
...
### Added
- First public alpha packaging baseline for X-Hub System docs and work-order framework.
- Core governance files (`LICENSE`, `NOTICE`, `SECURITY`, `CONTRIBUTING`, `CODE_OF_CONDUCT`).
- Initial CI workflows for memory benchmark and quality/security gates.

### Notes
- This alpha is release-candidate quality for architecture and workflow visibility.
- Some runtime paths and advanced modules are still marked as in-progress.
