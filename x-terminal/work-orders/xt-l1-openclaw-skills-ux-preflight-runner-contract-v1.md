# XT-L1：OpenClaw Skills 导入体验 / Preflight / Runner 约束契约（SKC-W1-02 协同 + SKC-W2-05 + SKC-W4-11）
...
目标：让 OpenClaw skill 在 X-Terminal 中做到“可搜索、可导入、可预检、可执行、可解释”，并以 fail-closed + machine-readable 证据交付。
