...
struct XTPrimarySidebarView: View {
    ...
    private static let projectSidebarReleaseDelayNanoseconds: UInt64 = 32_000_000
...
private struct XTPrimaryProjectCountBadge: View {
    ...
    var body: some View {
        XTPrimarySurfaceBadgeText(
            text: projectSidebarProjectionStore.snapshot.projectCountText,
...
private struct XTPrimarySidebarProjectCountChip: View {
    ...
    var body: some View {
        XTPrimarySidebarStatusChip(
            title: "Projects",
            value: projectSidebarProjectionStore.snapshot.projectCountText,
            tint: .secondary
        )
    }
}
...
private struct XTPrimarySidebarSelectedProjectLabel: View {
    ...
    private var selectedProjectName: String? {
        projectSidebarProjectionStore.snapshot.rows.first(where: \.isSelected)?.displayName
    }
}
