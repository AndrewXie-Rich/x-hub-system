...
extension SupervisorViewActionSupport {
    ...
    static func focusRequestExecutionDependencies(
        ...
        setHighlightedCandidateReviewAnchor: @escaping (String?) -> Void,
        ...
        refreshCandidateReviews: @escaping () -> Void,
        ...
        .init(
            ...
            setHighlightedCandidateReviewAnchor: setHighlightedCandidateReviewAnchor,
            ...
            refreshCandidateReviews: refreshCandidateReviews,
