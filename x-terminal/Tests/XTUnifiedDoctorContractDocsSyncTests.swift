...
struct XTUnifiedDoctorContractDocsSyncTests {
    ...
    func sourceReportContractFreezesStructuredProjectionEnvelope() throws {
        ...
        #expect(contract.contains("\"providerKeySelectionProjection\""))
        #expect(contract.contains("\"providerKeyRouteContextProjection\""))
        ...
        #expect(contract.contains("\"xt.unified_doctor_provider_key_selection_decision.v1\""))
        #expect(contract.contains("\"xt.unified_doctor_provider_key_candidate_decision.v1\""))
        #expect(contract.contains("\"xt.unified_doctor_provider_key_route_context.v1\""))
        #expect(contract.contains("\"xt.unified_doctor_provider_key_import_issue.v1\""))
    ...
    func docsAndFixturesKeepXtSourceReportContractVisible() throws {
        ...
        #expect(readme.contains("provider_key_selection_snapshot"))
        #expect(readme.contains("provider_key_route_context_snapshot"))
        ...
        #expect(xMemory.contains("providerKeySelectionProjection"))
        #expect(xMemory.contains("providerKeyRouteContextProjection"))
        #expect(xMemory.contains("provider_key_selection_snapshot"))
        #expect(xMemory.contains("provider_key_route_context_snapshot"))
        ...
        #expect(workingIndex.contains("providerKeySelectionProjection"))
        #expect(workingIndex.contains("providerKeyRouteContextProjection"))
        #expect(workingIndex.contains("provider_key_selection_snapshot"))
        #expect(workingIndex.contains("provider_key_route_context_snapshot"))
        ...
        #expect(xtReadme.contains("providerKeySelectionProjection"))
        #expect(xtReadme.contains("providerKeyRouteContextProjection"))
        #expect(xtReadme.contains("provider_key_selection_snapshot"))
        #expect(xtReadme.contains("provider_key_route_context_snapshot"))
        ...
        #expect(releaseGuide.contains("provider_key_selection_support"))
        #expect(releaseGuide.contains("provider_key_selection_snapshot"))
        #expect(releaseGuide.contains("provider_key_route_context_support"))
        #expect(releaseGuide.contains("provider_key_route_context_snapshot"))
        #expect(releaseGuide.contains("selected_account_key"))
        #expect(releaseGuide.contains("next_retry_at_ms"))
        #expect(releaseGuide.contains("primary_import_issue_ref"))
        ...
        #expect(xhubDoctorOutputSchema.contains("\"provider_key_selection_snapshot\""))
        #expect(xhubDoctorOutputSchema.contains("\"provider_key_route_context_snapshot\""))
        ...
        #expect(ciReadme.contains("provider_key_selection_support"))
        ...
        #expect(xtDoctorSource.contains("providerKeySelectionProjection"))
        #expect(xtDoctorSource.contains("providerKeyRouteContextProjection"))
        ...
        #expect(sourceGate.contains("compact_provider_key_selection_snapshot"))
        #expect(sourceGate.contains("compact_provider_key_route_context_snapshot"))
        #expect(sourceGate.contains("provider_key_selection_support"))
        #expect(sourceGate.contains("provider_key_route_context_support"))
        ...
        #expect(xtSmoke.contains("provider_key_selection_snapshot"))
        #expect(xtSmoke.contains("provider_key_route_context_snapshot"))
        ...
        #expect(allSmoke.contains("xt_provider_key_selection_snapshot"))
        #expect(allSmoke.contains("xt_provider_key_route_context_snapshot"))
