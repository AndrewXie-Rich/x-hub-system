...
const REQUIRED_DOC_NEEDLES = [
  ...
  'X-Hub is one product with a Rust product kernel and a Swift product shell',
  'Default UI stays Swift',
  'Rust browser page is diagnostics only',
  'Swift consumes the Rust kernel contract',
  'Node is compatibility, not product authority',
...
function main() {
  ...
  process.stdout.write(`${JSON.stringify({
    ...
    ml_execution_authority_runtime_gated: true,
