...
<div class="preview-note">
  <strong>这一页是首页 "Why this matters now" 的长版本。</strong>
  如果你已经清楚 per-action 确认、工具碎片化、AI 多用户形态在 2026 年中是问题——可以跳过。
</div>
...
| X-Hub 解决的问题 | X-Hub **不**解决的问题 |
|---|---|
| AI 做了你没授权的破坏性动作 | AI 给你错的事实信息 |
| AI 工具碎片、审计漏洞、按 vendor 锁死 | 模型本身的偏见、有害、幻觉 |
| MCP server / 插件 供应链风险 | 底层模型的运行成本 |
| AI 活动的合规证据 | 合规认证本身(SOC 2、ISO 等——那些是审计) |
| 围绕 AI 动作的家庭家长控制 | 过滤孩子能问 AI 什么(那是内容审核,不同工具) |
| 共享 AI 的多用户治理 | AI 是否应该被允许进入你的学校 / 工作场所 / 行业 |

X-Hub 是个控制面产品。它管 *AI 周围发生什么*,不管 *AI 想什么*。如果你的问题是"我想知道我的 AI 诚实不诚实",那是另一个类别。如果你的问题是"我想知道我的 AI 做了什么、在错的事落地之前拦下",那是 X-Hub。
