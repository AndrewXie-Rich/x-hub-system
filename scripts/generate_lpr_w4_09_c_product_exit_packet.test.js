...
run("product exit packet surfaces provider key selection focus for internal operator handoff", () => {
  const packet = buildProductExitPacket({
    operatorRecovery: makeOperatorRecovery(),
    operatorChannelRecovery: makeOperatorChannelRecovery(),
    requireReal: makeRequireReal(),
  ...
  assert.deepEqual(packet.operator_handoff.provider_key_selection_focus, {
    support_ready: true,
...
run("product exit packet preserves compact provider key selection support for operator handoff", () => {
  const packet = buildProductExitPacket({
    operatorRecovery: makeOperatorRecovery(),
    operatorChannelRecovery: makeOperatorChannelRecovery(),
    requireReal: makeRequireReal(),
  ...
  assert.deepEqual(packet.support_truth.doctor_source_gate.provider_key_selection_support, {
    xt_source_smoke_status: "pass",
    all_source_smoke_status: "pass",
    xt_source_provider_key_selection_snapshot: {
      requested_provider: "openai",
  ...
  assert.deepEqual(packet.support_truth.doctor_source_gate.provider_key_route_context_support, {
    xt_source_smoke_status: "pass",
    all_source_smoke_status: "pass",
    xt_source_provider_key_route_context_snapshot: {
      model_id: "openai/gpt-5.4",
