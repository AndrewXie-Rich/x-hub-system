...
provider_key_selection_snapshot = model_route.get("provider_key_selection_snapshot")
provider_key_route_context_snapshot = model_route.get("provider_key_route_context_snapshot")
...
assert provider_key_selection_snapshot is not None, model_route
assert provider_key_route_context_snapshot is not None, model_route
...
assert provider_key_selection_snapshot["requestedProvider"] == "openai", provider_key_selection_snapshot
assert provider_key_selection_snapshot["requestedModelId"] == "openai/gpt-5.4", provider_key_selection_snapshot
assert provider_key_selection_snapshot["selectedAccountKey"] == "openai:primary", provider_key_selection_snapshot
assert provider_key_selection_snapshot["candidates"][0]["wireAPI"] == "responses", provider_key_selection_snapshot
assert provider_key_selection_snapshot["candidates"][1]["availability"]["cooldown"]["reasonCode"] == "provider_timeout", provider_key_selection_snapshot
assert provider_key_selection_snapshot["candidates"][1]["availability"]["cooldown"]["retryAtMs"] == 1741300185000, provider_key_selection_snapshot
assert provider_key_route_context_snapshot["model_id"] == "openai/gpt-5.4", provider_key_route_context_snapshot
assert provider_key_route_context_snapshot["decision"]["selectedAccountKey"] == "openai:primary", provider_key_route_context_snapshot
assert provider_key_route_context_snapshot["import_issues"][0]["errorCode"] == "unsupported_toml_config", provider_key_route_context_snapshot
assert provider_key_route_context_snapshot["import_issues"][0]["sourceRef"] == "/Users/test/config149.toml", provider_key_route_context_snapshot
...
evidence = {
    ...
    "provider_key_selection_snapshot": provider_key_selection_snapshot,
    "provider_key_route_context_snapshot": provider_key_route_context_snapshot,
    ...
    "assertions": {
        ...
        "provider_key_requested_provider": {
            "expected": "openai",
            "actual": provider_key_selection_snapshot["requestedProvider"],
            "pass": provider_key_selection_snapshot["requestedProvider"] == "openai",
        },
        "provider_key_selected_account": {
            "expected": "openai:primary",
            "actual": provider_key_selection_snapshot["selectedAccountKey"],
            "pass": provider_key_selection_snapshot["selectedAccountKey"] == "openai:primary",
        },
        "provider_key_route_context_model_id": {
            "expected": "openai/gpt-5.4",
            "actual": provider_key_route_context_snapshot["model_id"],
            "pass": provider_key_route_context_snapshot["model_id"] == "openai/gpt-5.4",
        },
        "provider_key_route_context_primary_import_issue": {
            "expected": "unsupported_toml_config",
            "actual": provider_key_route_context_snapshot["import_issues"][0]["errorCode"],
            "pass": provider_key_route_context_snapshot["import_issues"][0]["errorCode"] == "unsupported_toml_config",
        },
        "provider_key_next_retry_at_ms": {
            "expected": 1741300185000,
            "actual": provider_key_selection_snapshot["candidates"][1]["availability"]["cooldown"]["retryAtMs"],
            "pass": provider_key_selection_snapshot["candidates"][1]["availability"]["cooldown"]["retryAtMs"] == 1741300185000,
        },
