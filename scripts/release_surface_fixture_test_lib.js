...
function createReleaseSurfaceFixture() {
  ...
  writeText(
    ...
    [
      ...
      "## Quick Start",
      "",
      "Run `bash \"/Users/andrew.xie/Documents/AX/rust/rust xt/swift-xterminal/scripts/ci/xt_release_gate.sh\"` to reproduce the XT release smoke.",
      "",
  ...
  writeJson(root, "build/reports/xt_stale_profile_repair_evidence.v1.json", {
    status: "pass",
  });
  ...
  writeJson(root, "build/reports/xhub_doctor_source_gate_summary.v1.json", {
    ...
    provider_key_selection_support: {
      xt_source_smoke_status: "pass",
      all_source_smoke_status: "pass",
      xt_source_provider_key_selection_snapshot: {
      ...
      all_source_provider_key_selection_snapshot: {
        requested_provider: "openai",
        requested_model_id: "openai/gpt-5.4",
        strategy: "pool_priority",
        selection_scope: "provider=openai model=openai/gpt-5.4",
    ...
    xt_stale_profile_repair_support: {
      xt_pairing_repair_smoke_status: "pass",
      xt_stale_profile_repair_evidence_ref: "build/reports/xt_stale_profile_repair_evidence.v1.json",
      xt_stale_profile_repair_snapshot: {
        case_count: 3,
        discovery_fail_closed_reason_codes: [
          "hub_instance_mismatch",
          "pairing_profile_epoch_stale",
          "route_pack_outdated",
        ],
        connect_refresh_skip_reason_codes: [
        ...
        completion_definition_failure_codes: [
          "invite_token_invalid",
          "unauthenticated",
          "certificate_required",
          "hub_instance_mismatch",
        ...
        cases: [
          {
            failure_code: "invite_token_invalid",
            mapped_issue: "pairing_repair_required",
            probe_stage: "connect_failure",
            probe_reason_code: "invite_token_invalid",
            paired_route_readiness: "remote_blocked",
            paired_route_reason_code: "remote_pairing_or_identity_blocked",
            should_fail_closed_on_discovery: false,
            should_skip_bootstrap_refresh_after_connect_failure: true,
          },
          {
            failure_code: "hub_instance_mismatch",
            mapped_issue: "pairing_repair_required",
          ...
          {
            failure_code: "route_pack_outdated",
            mapped_issue: "pairing_repair_required",
