...
function printUsage(exitCode) {
  const message = [
    ...
    "  node scripts/prepare_lpr_w3_03_require_real_sample.js --sample-id lpr_rr_03_vision_real_model_dir_exercised",
    "  node scripts/prepare_lpr_w3_03_require_real_sample.js --force",
    "  node scripts/prepare_lpr_w3_03_require_real_sample.js --json",
    "",
  ].join("\n");
...
function manifestForSample(sample) {
  ...
  return {
    schema_version: "xhub.lpr_w3_03_require_real_sample_scaffold.v1",
...
function prepareSampleScaffold(sample, options = {}) {
  ...
  const evidenceDir = path.join(reportsDir, "lpr_w3_03_require_real", sample.sample_id);
