...
const {
  ...
  renderUpdateCommand,
} = require("./xt_w3_31_require_real_status.js");
...
function printUsage(exitCode) {
  const message = [
    ...
    "  node scripts/prepare_xt_w3_31_require_real_sample.js --sample-id xt_spf_rr_05_three_project_burst_has_no_duplicate_interrupt_flood",
    "  node scripts/prepare_xt_w3_31_require_real_sample.js --force",
    "  node scripts/prepare_xt_w3_31_require_real_sample.js --json",
    "",
  ].join("\n");
...
function manifestForSample(sample) {
  ...
  return {
    schema_version: "xhub.xt_w3_31_require_real_sample_scaffold.v1",
...
function prepareSampleScaffold(sample, options = {}) {
  ...
  const evidenceDir = path.join(reportsDir, "xt_w3_31_require_real", sample.sample_id);
