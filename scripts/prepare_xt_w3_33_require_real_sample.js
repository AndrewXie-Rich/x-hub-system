...
const {
  ...
  renderUpdateCommand,
} = require("./xt_w3_33_require_real_status.js");
...
function printUsage(exitCode) {
  const message = [
    "usage:",
    "  node scripts/prepare_xt_w3_33_require_real_sample.js",
    "  node scripts/prepare_xt_w3_33_require_real_sample.js --sample-id xt_w3_33_rr_04_low_risk_default_proposal_stays_pending",
    "  node scripts/prepare_xt_w3_33_require_real_sample.js --force",
    "  node scripts/prepare_xt_w3_33_require_real_sample.js --json",
    "",
  ].join("\n");
...
function manifestForSample(sample) {
  ...
  return {
    schema_version: "xhub.xt_w3_33_require_real_sample_scaffold.v1",
...
function prepareSampleScaffold(sample, options = {}) {
  ...
  const evidenceDir = path.join(reportsDir, "xt_w3_33_require_real", sample.sample_id);
