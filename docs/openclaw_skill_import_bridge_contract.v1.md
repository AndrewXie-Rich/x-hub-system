# OpenClaw Skill 导入桥接契约（Client Pull + Upload + Pin）v1
...
- scope: `SKC-W1-02`
- status: frozen
- machine-readable contract: `docs/openclaw_skill_abi_compat.v1.json#import_bridge_contract`

## 1) 协议目标

在不改变 OpenClaw 本机 add 心智的前提下，打通 Hub 纳管闭环：
- 本机继续按 OpenClaw 习惯拉包（client pull）。
