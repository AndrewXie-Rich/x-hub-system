...
```
虚拟路径                          真实路径
/mnt/user-data/workspace    →    ~/Library/Application Support/XTerminal/projects/{id}/workspace
/mnt/user-data/uploads      →    ~/Library/Application Support/XTerminal/projects/{id}/uploads
/mnt/user-data/outputs      →    ~/Library/Application Support/XTerminal/projects/{id}/outputs
```
